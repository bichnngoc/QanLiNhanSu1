...
public partial class NV_TT : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["MaNhanVien"] != null)
        {
            ...
            Session["MaNhanVienChamCong"] = maNhanVien;
            Session["MaNhanVienKiluat"] = maNhanVien;
            Session["MaNhanVienKhenThuong"] = maNhanVien;
            Session["MaNhanVienLuong"] = maNhanVien;
        }
        else
        {
