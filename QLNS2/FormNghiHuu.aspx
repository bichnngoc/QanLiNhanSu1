<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormNghiHuu.aspx.cs" Inherits="FormNghiHuu" MasterPageFile="Site.master" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
<div class="container-xxl flex-grow-1 container-p-y">
     <div class="col-12">
         <div class="card mb-4">
             <h5 class="card-header">Nhân viên đã nghỉ hưu</h5>
             <div class="card-body"><br />
                 <div class="row">
                     <asp:GridView ID="DGVNghihuu" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" AutoGenerateColumns="False" AutoGenerateSelectButton="True" >
                        <Columns>
