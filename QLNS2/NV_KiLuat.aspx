<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NV_KiLuat.aspx.cs" Inherits="NV_KiLuat" MasterPageFile="NV.master" %>
                    ...
                    <div class="card accordion-item pt-4">
                        <div id="collapseDeliveryAddress" class="accordion-collapse collapse show" aria-labelledby="headingDeliveryAddress" data-bs-parent="#collapsibleSection">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <asp:GridView ID="GV_KiLuat" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" AutoGenerateColumns="False">
                                        <Columns>
                                            <asp:BoundField DataField="MaNhanVien" HeaderText="Mã nhân viên" />
                                            <asp:BoundField DataField="Id" HeaderText="Mã kỉ luật" />
                                            <asp:BoundField DataField="KiLuat" HeaderText="Loại kỉ luật" />
                                            <asp:BoundField DataField="Tien" HeaderText="Số tiền bị trừ" />
                                        </Columns>
